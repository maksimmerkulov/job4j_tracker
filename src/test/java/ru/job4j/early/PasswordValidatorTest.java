 ...
 *     <li>Длина пароля находится в диапазоне [8, 32]</li>
 *     <li>Наличие хотя бы одной заглавной буквы</li>
 *     <li>Наличие хотя бы одной строчной буквы</li>
 *     <li>Наличие хотя бы одной цифры</li>
 *     <li>Наличие хотя бы одного специального символа</li>
 *     <li>Отсутствие запрещенных подстрок без учета регистра: {@code qwerty, 12345, password, admin, user}</li>
 * </ul>
 *
