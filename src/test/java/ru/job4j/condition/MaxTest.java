...
public class MaxTest {
    ...
    /**
     * Проверяет, что максимум — второй аргумент.
     *
    ...
    /**
     * Проверяет, что максимум — первый аргумент.
     *
     * <p>Проверка корректности возврата значения, когда {@code left > right}.</p>
     */
    @Test
    ...
    /**
     * Проверяет, что при равных аргументах возвращается одно из значений.
     *
     * <p>Проверка корректности возврата значения, когда {@code left == right}.</p>
     */
    @Test
    ...
    /**
     * Проверяет, что метод работает корректно с отрицательными числами.
     *
