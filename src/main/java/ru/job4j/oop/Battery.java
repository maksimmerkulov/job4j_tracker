...
public class Battery {
    ...
    /**
     * Метод {@code exchange()} передаёт заряд текущей батареи другой батарее.
    ...
    /**
     * Метод {@code main(String[] args)} демонстрирует работу класса {@code Battery}.
     * Создаёт два объекта {@code Battery}, выводит информацию о заряде до их обмена.
     *
