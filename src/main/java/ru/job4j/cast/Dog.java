 ...
 *
 * <p>Используется для демонстрации реализации интерфейса {@link Animal} и воспроизведения звука.</p>
 *
...
public class Dog implements Animal {
     ...
     *
     * <p>Формат вывода включает имя класса и фразу "произносит звук: Гав-гав."</p>
     */
    @Override
    public void sound() {
