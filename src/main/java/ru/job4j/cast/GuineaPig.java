 ...
 *
 * <p>Используется для демонстрации реализации интерфейса {@link Animal} и воспроизведения характерного звука.</p>
 *
...
public class GuineaPig implements Animal {
     ...
     *
     * <p>Формат вывода включает имя класса и фразу "громко пищит для привлечения внимания."</p>
     */
    @Override
    public void sound() {
