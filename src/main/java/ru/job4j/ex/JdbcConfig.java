 ...
 *
 * <p>Проверяет корректность переданного URL.
 * Если URL {@code null}, выбрасывается исключение {@link UserInputException}.</p>
 *
...
public class JdbcConfig {
    ...
    /**
     * Запускает демонстрационный пример использования метода {@link #load(String)}.
     *
     * <p>Использует конструкцию try-catch для обработки исключения {@link UserInputException}.</p>
     *
